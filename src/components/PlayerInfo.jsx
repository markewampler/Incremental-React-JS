...
function PlayerInfo({ player, onOpenLocationModal, onOpenPurchaseModal, onOpenClassChangeModal, onOpenDivinePointsModal }) {
  return (
    <div className="player-info">
      ...
      <div className="player-info-box dp">
        <div><h3>Divine Points: {player.dp}</h3></div>
        <button onClick={onOpenDivinePointsModal}>Spend Divine Points</button>
      </div>
      ...
      <div className="player-info-box wealth">
        <div><h3>Wealth: {player.wealth}</h3></div>
...
PlayerInfo.propTypes = {
  ...
  onOpenDivinePointsModal: PropTypes.func.isRequired,
};
